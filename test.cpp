...
//Inhertiance Concept can be included as including all the member functions in the derived class
//This project can be further extented and the billing system can be included as well
...
//Function to Generate Bill(Take BatchID as input and pass it another function)
void generateBill();
